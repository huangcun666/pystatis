...
MarkerClusterer.prototype.getExtendedBounds = function(bounds){
	...
	//alert(newSW.lng)
    var swPoint = new BMap.Point(newSW.lng,newSW.lat);
    var nePoint = new BMap.Point(newNE.lng, newNE.lat);  
...
Cluster.prototype.calculateBounds = function() {
    var swPoint = new BMap.Point(this.center.lng, this.center.lat);
    var nePoint = new BMap.Point(this.center.lng, this.center.lat);  
...
ClusterMarker.prototype.IMAGE_PATH = ctx + '/images/cluster/m';
...
ClusterMarker.prototype.fitBounds = function(map, bounds){
   ...
   //     ]);//BUG 不会触发zoom或move的change事件
     map.setViewport(bounds);//BUG 不会触发zoom或move的change事件
    map.zoomIn();
    map.zoomOut();
};//对Baidu.Map的扩展
